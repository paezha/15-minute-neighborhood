...
The method proposed involves to study 15-minute walking neighborhoods in two stages. The first stage comprises assessing accessibility levels from the normative perspective of the provision of opportunities. In the second stage, the results of this analysis are correlated to neighborhood network attributes, including connectivity, centrality, and clustering.
