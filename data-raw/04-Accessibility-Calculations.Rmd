...
In this document we calculate the amenities at the level of walkshed to get cumulative accessibility scores.
...
load(file = paste0(here::here(), 
                   "/data/amenities_points.rda"))
load(file = paste0(here::here(), 
...
```{r}
save(amenities_walksheds_da, 
     file = paste0(here::here(), 
                   "/data/amenities_walkshed_da.rda"),
     compress = "xz")
save(amenities_walksheds_validation, file = paste0(here::here(), 
                   "/data/amenities_walkshed_validation.rda"),
     compress = "xz")
```
...
Summary of amenities by h3 geometry:
```{r}
