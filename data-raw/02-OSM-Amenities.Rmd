...
save(sustenance, 
     file = paste0(here::here(), 
                   "/data/sustenance.rda"),
     compress = "xz")
save(education, file = paste0(here::here(), 
                   "/data/education.rda"),
     compress = "xz")
save(financial, file = paste0(here::here(), 
                   "/data/financial.rda"),
     compress = "xz")
save(healthcare, file = paste0(here::here(), 
                   "/data/healthcare.rda"),
     compress = "xz")
save(amenities_points, file = paste0(here::here(), 
