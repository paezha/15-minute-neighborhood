...
Also, sample in urban and suburban zones to replicate the number of points for DAs. We will this as a validation dataset. These are non-centroid origins:
```{r}
# For reproducibility
seed <- 22331264
set.seed(seed)
...
The origins are coordinates of centroids and non-centroids points in DAs and the destinations the coordinates of the h3 geohashes:
```{r prepare-inputs}
...
```{r}
save(urban_hammer_da, 
     file = paste0(here::here(), 
                   "/data/urban_hammer_da.rda"), 
     compress = "xz")
save(ttm_walk_da, 
     file = paste0(here::here(), 
                   "/data/ttm_walk_da.rda"), 
     compress = "xz")
save(walksheds_da, 
     file = paste0(here::here(), 
                   "/data/walksheds_da.rda"), 
     compress = "xz")
save(ttm_walk_validation, 
     file = paste0(here::here(), 
                   "/data/ttm_walk_validation.rda"), 
     compress = "xz")
save(walksheds_validation, 
     file = paste0(here::here(), 
